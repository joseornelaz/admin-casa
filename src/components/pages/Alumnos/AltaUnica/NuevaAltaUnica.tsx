  ...
  return (
    <Box
      sx={{
        ...
        height: "100%", // Ocupa el 100% de la altura de <Box component="main">
        // Compensamos el padding del parent 'main' para que la barra llegue hasta los bordes
        mx: { xs: -2, sm: -3, md: -4 },
        mt: { xs: -2, sm: -3, md: -4 },
        mb: { xs: -2, sm: -3, md: -4 },
      }}
    >
      {/* AREA DE CONTENIDO / FORMULARIO (Tiene su propio scroll) */}
      <Box
        sx={{
          flex: 1,
          overflowY: "auto",
          p: { xs: 2, sm: 3, md: 4 }, // Le devolvemos el padding al contenido
        }}
      >
        <Box
                sx={{
      ...
      {/* FOOTER ACCIONES (Fijo al fondo del canvas main) */}
        ...
        <ConfirmacionInscripcionDialog open={openConfirmDialog} onClose={() => setOpenConfirmDialog(false)} />
